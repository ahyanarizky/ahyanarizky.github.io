...
tambahKontak("ariz", "ariz@nana", 021); // Contoh menambah kontak baru
tambahKontak("nana", "nana@ariz",031);
tambahKontak("zakiy", "zakiy@syalala", 231);
lihatSemua(); // Untuk melihat semua daftar kontak
cariKontak("nana"); // Contoh untuk pencarian kontak menggunakan nama
